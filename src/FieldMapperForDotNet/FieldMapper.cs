...
namespace FieldMapperForDotNet
{
    ...
    public class FieldMapper
    {
        ...
        /// </summary>
        private readonly FieldMapperConfiguration _configuration;
        ...
        {
            _configuration = configuration ?? FieldMapperConfiguration.Default;
        }
        ...
        /// <returns></returns>
        private (string Content, string[] Keys) ValidateArguments(string content, IEnumerable<string> keys)
        {
        ...
        /// <param name="keys">The keys.</param>
        /// <returns></returns>
        public string PrepareContent(string content, IEnumerable<string> keys)
        {
            ...
            if (_configuration.Options.DeEntitizeContent)
            {
            ...
            if (_configuration.Options.SeparateByLineBreaks)
            {
        ...
        /// <param name="keys">The keys.</param>
        /// <returns></returns>
        public IDictionary<string, string> Parse(string content, IEnumerable<string> keys)
        {
            var arguments = ValidateArguments(
                content, keys);
