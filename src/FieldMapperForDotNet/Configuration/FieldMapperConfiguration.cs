namespace FieldMapperForDotNet
{
    ...
    public class FieldMapperConfiguration
    {
        ...
        /// <summary>
        /// You can modify the options to change how the field mapper works when running <see cref="FieldMapper.Parse(string, System.Collections.Generic.IEnumerable{string})"/>.
        /// </summary>
